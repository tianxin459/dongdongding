        ...
        text: [{
                index: {
                    ...
                    help: {
                        ...
                        TransDesc3: '收款二维码',
                        ChatRoom: '聊天室',
                        ChatRoomUrl: 'http://ellist.cn/bulletmessage/bullet.html',
                        ChatRoomDesc: '打开以上链接主屏幕，聊天信息同时会作为弹幕发送到主屏幕',
                        Album: '活动相册',
                        AlbumDesc: '活动相册，可以上传相片与他人分享',
                        RunningGame: '摇一摇赛跑',
                        RunningGameUrl: 'http://ellist.cn/bulletmessage/race.html',
                ...
                shake: {
                    ...
                    Url: '电脑上打开http://ellist.cn/bulletmessage/race.html'
                }
            },
            {
                index: {
                ...
                shake: {
                    ...
                    Url: 'open http://ellist.cn/bulletmessage/race.html'
                }
            }
        ]
    }
